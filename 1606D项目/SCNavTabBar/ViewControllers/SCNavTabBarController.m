...
/*************************修改了DOT_COORDINATE - 20************************/
    
    _navTabBar = [[SCNavTabBar alloc] initWithFrame:CGRectMake(DOT_COORDINATE, DOT_COORDINATE, SCREEN_WIDTH, NAV_TAB_BAR_HEIGHT + 20) showArrowButton:_showArrowButton];
