...
//        [self viewShowShadow:_arrowButton shadowRadius:20.0f shadowOpacity:20.0f];
        [self viewShowShadow:_arrowButton shadowRadius:0.0f shadowOpacity:0.0f];
...
//*********************修改了DOT_COORDINATE***************************************//
    _navgationTabBar = [[UIScrollView alloc] initWithFrame:CGRectMake(DOT_COORDINATE, DOT_COORDINATE +20, functionButtonX, NAV_TAB_BAR_HEIGHT)];
...
- (CGFloat)contentWidthAndAddNavTabBarItemsWithButtonsWidth:(NSArray *)widths
{
    ...
    for (NSInteger index = 0; index < [_itemTitles count]; index++)
    {
        ...
        button.titleLabel.font = [UIFont systemFontOfSize:17]; // 标题字体大小
